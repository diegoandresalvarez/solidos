...
* **Examen  2:** 25% 
    ...
    * Parte 2 (50%): (miércoles, abril 10, 2024, semana 8). Una hora de duración. Se harán dos preguntas. El tema a evaluar comprende desde la sección 6.4 (incluida) hasta el final del capítulo 6 y todos los códigos de MATLAB/MAXIMA/PYTHON asociados. Se incluyen del capítulo 5 las secciones 5.6, 5.7, 5.8 y 5.13.
