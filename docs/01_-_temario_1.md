...
* **Examen  2:** 25% 
    ...
    * Parte 2 (50%): (miércoles, abril 10, 2024, semana 9). Una hora de duración. Se harán dos preguntas. El tema a evaluar comprende desde la sección 6.4 (incluida) hasta el final del capítulo 6 y todos los códigos de MATLAB/MAXIMA/PYTHON asociados. Se incluyen del capítulo 5 las secciones 5.6, 5.7, 5.8 y 5.13.
* **Examen  3:** 25% (viernes, mayo 3, 2024, semana 12). Se evaluará el capítulo 7 y todos los códigos de MATLAB/MAXIMA/PYTHON asociados.
* **Examen  4:** 25% (miércoles, mayo 29, 2024, semana 16). Se evaluará el capítulo 16 y todos los códigos de MATLAB/MAXIMA/PYTHON asociados.
<!---
